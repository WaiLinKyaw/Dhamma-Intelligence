...
def init_and_seed_db():
    ...
    # Resources Data
    resources = [
        ("စိတ်ဖိစီးမှု လျှော့ချနည်းနှင့် သတိထားခြင်း တရားတော်", "video", "stress", "https://www.youtube.com/watch?v=ynZsOu0QScM&list=PLqnSdW-e2BagbqBfrQz9N6sHpKsgmHcDE&index=3"),
        ("ဒေါသကို သတိဖြင့် အနိုင်ယူခြင်း", "video", "anger", "https://www.youtube.com/watch?v=COWmKfwiHWo&list=PLqnSdW-e2BagbqBfrQz9N6sHpKsgmHcDE&index=7"),
        ("ဝမ်းနည်းကြေကွဲမှုကို ကုစားခြင်း", "video", "sadness", "https://www.youtube.com/watch?v=ynZsOu0QScM&list=PLqnSdW-e2BagbqBfrQz9N6sHpKsgmHcDE&index=3"),
        ("လက်ရှိပစ္စုပ္ပန်တည့်တည့်မှာ နေထိုင်နည်း", "video", "mindfulness", "https://www.youtube.com/watch?v=yjy3VRxskaA&list=PLqnSdW-e2BagbqBfrQz9N6sHpKsgmHcDE&index=4"),
        ("သောကကင်းဝေး စိတ်အေးချမ်းရေး စာအုပ်", "book", "stress", "books/stress_relief.pdf"),
        ("စိတ်ဖိစီးမှု လျှော့ချနည်းနှင့် သတိထားခြင်း စာအုပ်", "book", "sadness", "books/stress_relief.pdf"),
